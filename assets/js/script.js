$(document).ready(function() {
  ...
  function searchBtnCall() {
    ...
    $.ajax({
      ...
      $.ajax({
        ...
        $("#forecastSymbol1").attr(
          "src",
          "http://openweathermap.org/img/w/" +
            result.list[6].weather[0].icon +
            ".png"
        );
        $("#forecastSymbol2").attr(
          "src",
          "http://openweathermap.org/img/w/" +
            result.list[14].weather[0].icon +
            ".png"
        );
        $("#forecastSymbol3").attr(
          "src",
          "http://openweathermap.org/img/w/" +
            result.list[22].weather[0].icon +
            ".png"
        );
        $("#forecastSymbol4").attr(
          "src",
          "http://openweathermap.org/img/w/" +
            result.list[30].weather[0].icon +
            ".png"
        );
        $("#forecastSymbol5").attr(
          "src",
          "http://openweathermap.org/img/w/" +
            result.list[38].weather[0].icon +
            ".png"
        );
        ...
        $("#forecastHumidity1").text(
          "Humidity: " + result.list[6].main.humidity + "%"
        );
        $("#forecastHumidity2").text(
          "Humidity: " + result.list[14].main.humidity + "%"
        );
        $("#forecastHumidity3").text(
          "Humidity: " + result.list[22].main.humidity + "%"
        );
        $("#forecastHumidity4").text(
          "Humidity: " + result.list[30].main.humidity + "%"
        );
        $("#forecastHumidity5").text(
          "Humidity: " + result.list[38].main.humidity + "%"
        );
      });
    });
    storeSearch();
  ...
  function getSearch() {
    var storedSearch = localStorage.getItem("localSearch");
    if (storedSearch) {
